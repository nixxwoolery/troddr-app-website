-- Reuse existing vendors when a partner types a duplicate vendor name.
-- This prevents vendors_name_unique from surfacing in the dashboard when the
-- intended action is to link an existing directory vendor to an event.

-- Repair partner event saving after event media uploads.
-- Production can end up with the older RPC signature cached/deployed, which
-- rejects p_media_url even though the dashboard now sends it.

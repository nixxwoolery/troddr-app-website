...
CREATE OR REPLACE FUNCTION "public"."admin_dashboard_usage"("p_admin_token" "text", "p_limit" integer DEFAULT 200) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
$$;
ALTER FUNCTION "public"."admin_dashboard_usage"("p_admin_token" "text", "p_limit" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."delete_event_band"("p_token" "text", "p_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
$$;
ALTER FUNCTION "public"."delete_event_band"("p_token" "text", "p_id" "uuid") OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "public"."delete_event_pass"("p_token" "text", "p_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare v_event_id uuid;
...
$$;
ALTER FUNCTION "public"."delete_event_pass"("p_token" "text", "p_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_special_community_stats"("p_special_id" "uuid") RETURNS TABLE("special_id" "uuid", "interested_count" bigint, "going_count" bigint, "attended_count" bigint, "up_votes" bigint, "down_votes" bigint, "avg_rating" numeric, "avg_rating_value" numeric, "avg_rating_vibe" numeric, "avg_rating_experience" numeric, "avg_rating_organisation" numeric, "avg_rating_taste" numeric, "avg_rating_portions" numeric, "avg_rating_presentation" numeric, "avg_rating_drinks" numeric, "top_tags" "text"[])
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  with interaction_stats as (
    select si.special_id,
      count(distinct si.user_id) filter (where si.status = 'interested') as interested_count,
      count(distinct si.user_id) filter (where si.status = 'going') as going_count,
      count(distinct si.user_id) filter (where si.status = 'attended') as attended_count,
      count(*) filter (where si.vote = 'up') as up_votes,
      count(*) filter (where si.vote = 'down') as down_votes,
      round(avg(si.rating), 1) as avg_rating,
      round(avg(si.rating_value), 1) as avg_rating_value,
      round(avg(si.rating_vibe), 1) as avg_rating_vibe,
      round(avg(si.rating_experience), 1) as avg_rating_experience,
      round(avg(si.rating_organisation), 1) as avg_rating_organisation,
      round(avg(si.rating_taste), 1) as avg_rating_taste,
      round(avg(si.rating_portions), 1) as avg_rating_portions,
      round(avg(si.rating_presentation), 1) as avg_rating_presentation,
      round(avg(si.rating_drinks), 1) as avg_rating_drinks
    from public.special_interactions si
    where si.special_id = p_special_id
    group by si.special_id
  ), tag_counts as (
    select si.special_id, tag.tag, count(*) as tag_count
    from public.special_interactions si
    ...
    from (
      select tc.special_id, tc.tag, tc.tag_count,
        row_number() over (partition by tc.special_id order by tc.tag_count desc, tc.tag) as rn
      from tag_counts tc
    ) ranked
    where ranked.rn <= 6
  ...
  select s.special_id,
    s.interested_count, s.going_count, s.attended_count,
    s.up_votes, s.down_votes,
    s.avg_rating, s.avg_rating_value, s.avg_rating_vibe, s.avg_rating_experience,
    s.avg_rating_organisation, s.avg_rating_taste, s.avg_rating_portions,
    s.avg_rating_presentation, s.avg_rating_drinks,
    coalesce(t.top_tags, '{}'::text[]) as top_tags
  from interaction_stats s
    left join top_tags t on t.special_id = s.special_id;
$$;
ALTER FUNCTION "public"."get_special_community_stats"("p_special_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."track_partner_dashboard_access"("p_token" "text", "p_path" "text" DEFAULT NULL::"text", "p_user_agent" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
$$;
ALTER FUNCTION "public"."track_partner_dashboard_access"("p_token" "text", "p_path" "text", "p_user_agent" "text") OWNER TO "postgres";
...
begin
  ...
  update public.events set
    ...
    know_before_you_go = case when p_know_before_you_go is not null then p_know_before_you_go else know_before_you_go end,
    parking_info       = case when p_parking_info is not null then nullif(trim(p_parking_info), '') else parking_info end,
    accessibility_info = case when p_accessibility_info is not null then nullif(trim(p_accessibility_info), '') else accessibility_info end,
    weather_contingency = case when p_weather_contingency is not null then nullif(trim(p_weather_contingency), '') else weather_contingency end,
...
CREATE OR REPLACE FUNCTION "public"."upsert_event_band"("p_token" "text", "p_id" "uuid" DEFAULT NULL::"uuid", "p_name" "text" DEFAULT NULL::"text", "p_tagline" "text" DEFAULT NULL::"text", "p_website_url" "text" DEFAULT NULL::"text", "p_instagram" "text" DEFAULT NULL::"text", "p_logo_url" "text" DEFAULT NULL::"text", "p_registration_deadline" "text" DEFAULT NULL::"text", "p_launch_date" "text" DEFAULT NULL::"text", "p_is_featured" boolean DEFAULT NULL::boolean) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
$$;
ALTER FUNCTION "public"."upsert_event_band"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tagline" "text", "p_website_url" "text", "p_instagram" "text", "p_logo_url" "text", "p_registration_deadline" "text", "p_launch_date" "text", "p_is_featured" boolean) OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "public"."upsert_event_pass"("p_token" "text", "p_id" "uuid" DEFAULT NULL::"uuid", "p_name" "text" DEFAULT NULL::"text", "p_tier" "text" DEFAULT NULL::"text", "p_description" "text" DEFAULT NULL::"text", "p_price" numeric DEFAULT NULL::numeric, "p_currency" "text" DEFAULT NULL::"text", "p_color" "text" DEFAULT NULL::"text", "p_is_featured" boolean DEFAULT NULL::boolean) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
$$;
ALTER FUNCTION "public"."upsert_event_pass"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tier" "text", "p_description" "text", "p_price" numeric, "p_currency" "text", "p_color" "text", "p_is_featured" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."upsert_schedule_item"("p_token" "text", "p_id" "uuid" DEFAULT NULL::"uuid", "p_day_id" "uuid" DEFAULT NULL::"uuid", "p_title" "text" DEFAULT NULL::"text", "p_subtitle" "text" DEFAULT NULL::"text", "p_start_time" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_end_time" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_venue_override" "text" DEFAULT NULL::"text", "p_category" "text" DEFAULT NULL::"text", "p_image_url" "text" DEFAULT NULL::"text", "p_is_featured" boolean DEFAULT false, "p_is_must_see" boolean DEFAULT false, "p_is_published" boolean DEFAULT true, "p_display_order" integer DEFAULT NULL::integer) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
$$;
ALTER FUNCTION "public"."upsert_schedule_item"("p_token" "text", "p_id" "uuid", "p_day_id" "uuid", "p_title" "text", "p_subtitle" "text", "p_start_time" timestamp with time zone, "p_end_time" timestamp with time zone, "p_venue_override" "text", "p_category" "text", "p_image_url" "text", "p_is_featured" boolean, "p_is_must_see" boolean, "p_is_published" boolean, "p_display_order" integer) OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."activation_funnel" WITH ("security_invoker"='true') AS
 SELECT "esa"."event_id",
...
CREATE OR REPLACE VIEW "public"."event_analytics_rollup" WITH ("security_invoker"='true') AS
 SELECT "event_id",
    "event_name",
    "count"(*) AS "total",
...
CREATE OR REPLACE VIEW "public"."event_partner_submission_summary" WITH ("security_invoker"='true') AS
 SELECT "id",
    "token",
    "status",
    "contact_name",
...
CREATE OR REPLACE VIEW "public"."event_retention_30d" WITH ("security_invoker"='true') AS
 WITH "attendees" AS (
...
CREATE OR REPLACE VIEW "public"."event_series_rollup" WITH ("security_invoker"='true') AS
...
CREATE OR REPLACE VIEW "public"."event_vendors_with_menu" WITH ("security_invoker"='true') AS
...
CREATE OR REPLACE VIEW "public"."feedback_sorted" WITH ("security_invoker"='true') AS
 SELECT "id",
    "user_id",
    "username",
    "category",
...
CREATE OR REPLACE VIEW "public"."guide_analytics" WITH ("security_invoker"='true') AS
...
CREATE TABLE IF NOT EXISTS "public"."partner_dashboard_access_log" (
    ...
    "user_agent" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "partner_dashboard_access_log_entity_type_check" CHECK (("entity_type" = ANY (ARRAY['event'::"text", 'place'::"text"])))
);
ALTER TABLE "public"."partner_dashboard_access_log" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."place_analytics" WITH ("security_invoker"='true') AS
...
CREATE OR REPLACE VIEW "public"."schedule_full" WITH ("security_invoker"='true') AS
 SELECT "si"."id",
    "si"."event_id",
    "si"."day_id",
    "si"."track_id",
...
CREATE OR REPLACE VIEW "public"."special_analytics" WITH ("security_invoker"='true') AS
...
CREATE OR REPLACE VIEW "public"."sponsor_activation_funnel" WITH ("security_invoker"='true') AS
 SELECT "event_id",
    "sponsor_id",
    "activation_id",
...
CREATE OR REPLACE VIEW "public"."sponsor_analytics_rollup" WITH ("security_invoker"='true') AS
 SELECT "event_id",
    "sponsor_id",
    "event_name",
    "count"(*) AS "total",
...
CREATE OR REPLACE VIEW "public"."user_xp_totals" WITH ("security_invoker"='true') AS
 SELECT "user_id",
...
CREATE OR REPLACE VIEW "public"."view_guide_details" WITH ("security_invoker"='true') AS
...
ALTER TABLE ONLY "public"."partner_dashboard_access_log"
    ADD CONSTRAINT "partner_dashboard_access_log_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "event_schedule_items_lineup_order_idx" ON "public"."event_schedule_items" USING "btree" ("event_id", "day_id", "display_order", "start_time");
...
CREATE INDEX "idx_event_passes_event" ON "public"."event_passes" USING "btree" ("event_id");
...
CREATE INDEX "partner_dashboard_access_created_idx" ON "public"."partner_dashboard_access_log" USING "btree" ("created_at" DESC);
CREATE INDEX "partner_dashboard_access_entity_idx" ON "public"."partner_dashboard_access_log" USING "btree" ("entity_type", "entity_id", "created_at" DESC);
...
CREATE OR REPLACE VIEW "public"."event_activation_summary" WITH ("security_invoker"='true') AS
 SELECT "a"."id",
    "a"."event_id",
    "a"."sponsor_id",
    "a"."name",
...
CREATE POLICY "Trip owner can invite collaborators" ON "public"."trip_collaborators" FOR INSERT TO "authenticated" WITH CHECK ((("invited_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."itineraries"
  WHERE (("itineraries"."id" = "trip_collaborators"."trip_id") AND ("itineraries"."user_id" = "auth"."uid"()))))));
...
ALTER TABLE "public"."event_map_points" ENABLE ROW LEVEL SECURITY;
CREATE POLICY "event_map_points_public_read" ON "public"."event_map_points" FOR SELECT USING (true);
...
CREATE POLICY "event_passes_admin_write" ON "public"."event_passes" USING (("auth"."role"() = 'service_role'::"text"));
CREATE POLICY "event_passes_public_read" ON "public"."event_passes" FOR SELECT USING (true);
...
ALTER TABLE "public"."event_schedule_meta" ENABLE ROW LEVEL SECURITY;
CREATE POLICY "event_schedule_meta_public_read" ON "public"."event_schedule_meta" FOR SELECT USING (true);
...
CREATE POLICY "event_vendors_public_read" ON "public"."event_vendors" FOR SELECT USING (true);
ALTER TABLE "public"."events" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "public"."favorites" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "public"."favourite_guides" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "public"."feedback" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "public"."guide_route_steps" ENABLE ROW LEVEL SECURITY;
CREATE POLICY "guide_route_steps_public_read" ON "public"."guide_route_steps" FOR SELECT USING (true);
...
ALTER TABLE "public"."performer_group_members" ENABLE ROW LEVEL SECURITY;
CREATE POLICY "performer_group_members_public_read" ON "public"."performer_group_members" FOR SELECT USING (true);
ALTER TABLE "public"."performer_schedule" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "ranking_events_delete_own" ON "public"."ranking_events" FOR DELETE USING (("auth"."uid"() = "user_id"));
CREATE POLICY "ranking_events_insert_own" ON "public"."ranking_events" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
CREATE POLICY "ranking_events_select_own" ON "public"."ranking_events" FOR SELECT USING (("auth"."uid"() = "user_id"));
CREATE POLICY "ranking_events_update_own" ON "public"."ranking_events" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "schedule_change_log_public_read" ON "public"."schedule_change_log" FOR SELECT USING (true);
...
CREATE POLICY "ticket_locations_public_read" ON "public"."ticket_locations" FOR SELECT USING (true);
...
CREATE POLICY "trip_collaborators_inviter_select" ON "public"."trip_collaborators" FOR SELECT USING (("invited_by" = "auth"."uid"()));
CREATE POLICY "trip_collaborators_member_insert" ON "public"."trip_collaborators" FOR INSERT WITH CHECK ((("invited_by" = "auth"."uid"()) AND ("public"."is_trip_owner"("trip_id") OR "public"."is_trip_collaborator"("trip_id"))));
CREATE POLICY "trip_collaborators_owner_select" ON "public"."trip_collaborators" FOR SELECT USING ("public"."is_trip_owner"("trip_id"));
...
ALTER TABLE "public"."user_place_rankings" ENABLE ROW LEVEL SECURITY;
CREATE POLICY "user_place_rankings_delete_own" ON "public"."user_place_rankings" FOR DELETE USING (("auth"."uid"() = "user_id"));
CREATE POLICY "user_place_rankings_insert_own" ON "public"."user_place_rankings" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
CREATE POLICY "user_place_rankings_select_own" ON "public"."user_place_rankings" FOR SELECT USING (("auth"."uid"() = "user_id"));
CREATE POLICY "user_place_rankings_update_own" ON "public"."user_place_rankings" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "user_tour_progress_delete_own" ON "public"."user_tour_progress" FOR DELETE USING (("auth"."uid"() = "user_id"));
CREATE POLICY "user_tour_progress_insert_own" ON "public"."user_tour_progress" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
CREATE POLICY "user_tour_progress_select_own" ON "public"."user_tour_progress" FOR SELECT USING (("auth"."uid"() = "user_id"));
CREATE POLICY "user_tour_progress_update_own" ON "public"."user_tour_progress" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "vendor_menu_items_public_read" ON "public"."vendor_menu_items" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."admin_dashboard_usage"("p_admin_token" "text", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."admin_dashboard_usage"("p_admin_token" "text", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_dashboard_usage"("p_admin_token" "text", "p_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."delete_event_band"("p_token" "text", "p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."delete_event_band"("p_token" "text", "p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_event_band"("p_token" "text", "p_id" "uuid") TO "service_role";
GRANT ALL ON FUNCTION "public"."delete_event_pass"("p_token" "text", "p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."delete_event_pass"("p_token" "text", "p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_event_pass"("p_token" "text", "p_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_special_community_stats"("p_special_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_special_community_stats"("p_special_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_special_community_stats"("p_special_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."track_partner_dashboard_access"("p_token" "text", "p_path" "text", "p_user_agent" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."track_partner_dashboard_access"("p_token" "text", "p_path" "text", "p_user_agent" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_partner_dashboard_access"("p_token" "text", "p_path" "text", "p_user_agent" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_partner_event"("p_token" "text", "p_title" "text", "p_description" "text", "p_short_description" "text", "p_start_date" "date", "p_end_date" "date", "p_start_time" time without time zone, "p_end_time" time without time zone, "p_is_all_day" boolean, "p_timezone" "text", "p_venue_name" "text", "p_venue_address" "text", "p_parish" "text", "p_town" "text", "p_country" "text", "p_is_free" boolean, "p_ticket_price_min" numeric, "p_ticket_price_max" numeric, "p_currency" "text", "p_has_online_tickets" boolean, "p_is_sold_out" boolean, "p_ticket_url" "text", "p_capacity" integer, "p_min_age" integer, "p_dress_code" "text", "p_food_available" boolean, "p_alcohol_served" boolean, "p_organizer_name" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_support_email" "text", "p_support_phone" "text", "p_support_url" "text", "p_website_url" "text", "p_instagram_url" "text", "p_featured_image_url" "text", "p_event_type" "text", "p_know_before_you_go" "jsonb", "p_parking_info" "text", "p_accessibility_info" "text", "p_weather_contingency" "text", "p_info_sections" "jsonb", "p_faq" "jsonb", "p_parking_image_url" "text", "p_parking_image_urls" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."update_partner_event"("p_token" "text", "p_title" "text", "p_description" "text", "p_short_description" "text", "p_start_date" "date", "p_end_date" "date", "p_start_time" time without time zone, "p_end_time" time without time zone, "p_is_all_day" boolean, "p_timezone" "text", "p_venue_name" "text", "p_venue_address" "text", "p_parish" "text", "p_town" "text", "p_country" "text", "p_is_free" boolean, "p_ticket_price_min" numeric, "p_ticket_price_max" numeric, "p_currency" "text", "p_has_online_tickets" boolean, "p_is_sold_out" boolean, "p_ticket_url" "text", "p_capacity" integer, "p_min_age" integer, "p_dress_code" "text", "p_food_available" boolean, "p_alcohol_served" boolean, "p_organizer_name" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_support_email" "text", "p_support_phone" "text", "p_support_url" "text", "p_website_url" "text", "p_instagram_url" "text", "p_featured_image_url" "text", "p_event_type" "text", "p_know_before_you_go" "jsonb", "p_parking_info" "text", "p_accessibility_info" "text", "p_weather_contingency" "text", "p_info_sections" "jsonb", "p_faq" "jsonb", "p_parking_image_url" "text", "p_parking_image_urls" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_partner_event"("p_token" "text", "p_title" "text", "p_description" "text", "p_short_description" "text", "p_start_date" "date", "p_end_date" "date", "p_start_time" time without time zone, "p_end_time" time without time zone, "p_is_all_day" boolean, "p_timezone" "text", "p_venue_name" "text", "p_venue_address" "text", "p_parish" "text", "p_town" "text", "p_country" "text", "p_is_free" boolean, "p_ticket_price_min" numeric, "p_ticket_price_max" numeric, "p_currency" "text", "p_has_online_tickets" boolean, "p_is_sold_out" boolean, "p_ticket_url" "text", "p_capacity" integer, "p_min_age" integer, "p_dress_code" "text", "p_food_available" boolean, "p_alcohol_served" boolean, "p_organizer_name" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_support_email" "text", "p_support_phone" "text", "p_support_url" "text", "p_website_url" "text", "p_instagram_url" "text", "p_featured_image_url" "text", "p_event_type" "text", "p_know_before_you_go" "jsonb", "p_parking_info" "text", "p_accessibility_info" "text", "p_weather_contingency" "text", "p_info_sections" "jsonb", "p_faq" "jsonb", "p_parking_image_url" "text", "p_parking_image_urls" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."upsert_event_band"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tagline" "text", "p_website_url" "text", "p_instagram" "text", "p_logo_url" "text", "p_registration_deadline" "text", "p_launch_date" "text", "p_is_featured" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_event_band"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tagline" "text", "p_website_url" "text", "p_instagram" "text", "p_logo_url" "text", "p_registration_deadline" "text", "p_launch_date" "text", "p_is_featured" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_event_band"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tagline" "text", "p_website_url" "text", "p_instagram" "text", "p_logo_url" "text", "p_registration_deadline" "text", "p_launch_date" "text", "p_is_featured" boolean) TO "service_role";
GRANT ALL ON FUNCTION "public"."upsert_event_pass"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tier" "text", "p_description" "text", "p_price" numeric, "p_currency" "text", "p_color" "text", "p_is_featured" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_event_pass"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tier" "text", "p_description" "text", "p_price" numeric, "p_currency" "text", "p_color" "text", "p_is_featured" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_event_pass"("p_token" "text", "p_id" "uuid", "p_name" "text", "p_tier" "text", "p_description" "text", "p_price" numeric, "p_currency" "text", "p_color" "text", "p_is_featured" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."upsert_schedule_item"("p_token" "text", "p_id" "uuid", "p_day_id" "uuid", "p_title" "text", "p_subtitle" "text", "p_start_time" timestamp with time zone, "p_end_time" timestamp with time zone, "p_venue_override" "text", "p_category" "text", "p_image_url" "text", "p_is_featured" boolean, "p_is_must_see" boolean, "p_is_published" boolean, "p_display_order" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_schedule_item"("p_token" "text", "p_id" "uuid", "p_day_id" "uuid", "p_title" "text", "p_subtitle" "text", "p_start_time" timestamp with time zone, "p_end_time" timestamp with time zone, "p_venue_override" "text", "p_category" "text", "p_image_url" "text", "p_is_featured" boolean, "p_is_must_see" boolean, "p_is_published" boolean, "p_display_order" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_schedule_item"("p_token" "text", "p_id" "uuid", "p_day_id" "uuid", "p_title" "text", "p_subtitle" "text", "p_start_time" timestamp with time zone, "p_end_time" timestamp with time zone, "p_venue_override" "text", "p_category" "text", "p_image_url" "text", "p_is_featured" boolean, "p_is_must_see" boolean, "p_is_published" boolean, "p_display_order" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."partner_dashboard_access_log" TO "anon";
GRANT ALL ON TABLE "public"."partner_dashboard_access_log" TO "authenticated";
GRANT ALL ON TABLE "public"."partner_dashboard_access_log" TO "service_role";
...
drop policy "Public can insert assets metadata" on "public"."event_partner_submission_assets";
drop policy "Public can update assets metadata" on "public"."event_partner_submission_assets";
drop policy "Public can create submissions" on "public"."event_partner_submissions";
drop policy "Public can read activations" on "public"."event_sponsor_activations";
drop policy "active event sponsors are publicly readable" on "public"."event_sponsors";
drop policy "active sponsors are publicly readable" on "public"."sponsors";
...
revoke delete on table "public"."itineraries" from "anon";
revoke insert on table "public"."itineraries" from "anon";
revoke references on table "public"."itineraries" from "anon";
revoke select on table "public"."itineraries" from "anon";
revoke trigger on table "public"."itineraries" from "anon";
revoke truncate on table "public"."itineraries" from "anon";
revoke update on table "public"."itineraries" from "anon";
revoke delete on table "public"."itinerary_places" from "anon";
revoke insert on table "public"."itinerary_places" from "anon";
revoke references on table "public"."itinerary_places" from "anon";
revoke select on table "public"."itinerary_places" from "anon";
revoke trigger on table "public"."itinerary_places" from "anon";
revoke truncate on table "public"."itinerary_places" from "anon";
revoke update on table "public"."itinerary_places" from "anon";
revoke delete on table "public"."itinerary_shares" from "anon";
revoke insert on table "public"."itinerary_shares" from "anon";
revoke references on table "public"."itinerary_shares" from "anon";
revoke select on table "public"."itinerary_shares" from "anon";
revoke trigger on table "public"."itinerary_shares" from "anon";
revoke truncate on table "public"."itinerary_shares" from "anon";
revoke update on table "public"."itinerary_shares" from "anon";
...
create policy "Public can insert assets metadata"
  on "public"."event_partner_submission_assets"
  as permissive
  for insert
  to anon, authenticated
with check (true);
create policy "Public can update assets metadata"
  on "public"."event_partner_submission_assets"
  as permissive
  for update
  to anon, authenticated
...
create policy "Public can create submissions"
  ...
  to anon, authenticated
with check (true);
create policy "Public can read activations"
  on "public"."event_sponsor_activations"
  as permissive
  for select
  to anon, authenticated
...
create policy "Public can read intake assets"
  on "storage"."objects"
  as permissive
  for select
  to anon, authenticated
using ((bucket_id = 'partner-intake-assets'::text));
create policy "Public can update intake assets"
  on "storage"."objects"
  as permissive
  for update
  to anon, authenticated
using ((bucket_id = 'partner-intake-assets'::text))
with check ((bucket_id = 'partner-intake-assets'::text));
create policy "Public can upload intake assets"
  on "storage"."objects"
  as permissive
  for insert
  to anon, authenticated
...
create policy "company members read own receipts"
  ...
  for select
  to authenticated
using (((bucket_id = 'payment-receipts'::text) AND ((storage.foldername(name))[1] IN ( SELECT (cu.company_account_id)::text AS company_account_id
   FROM public.company_users cu
  WHERE ((cu.user_id = auth.uid()) AND (cu.status <> 'removed'::text))))));
create policy "company members upload own receipts"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check (((bucket_id = 'payment-receipts'::text) AND (lower(COALESCE(storage.extension(name), ''::text)) = ANY (ARRAY['pdf'::text, 'jpg'::text, 'jpeg'::text, 'png'::text])) AND ((storage.foldername(name))[1] IN ( SELECT (cu.company_account_id)::text AS company_account_id
   FROM public.company_users cu
  WHERE ((cu.user_id = auth.uid()) AND (cu.status <> 'removed'::text))))));
create policy "event-floorplans authenticated insert"
  ...
  for insert
  to anon, authenticated
with check ((bucket_id = 'event-floorplans'::text));
create policy "event-floorplans authenticated update"
  on "storage"."objects"
  as permissive
  for update
  to anon, authenticated
using ((bucket_id = 'event-floorplans'::text))
with check ((bucket_id = 'event-floorplans'::text));
